...
RepoGate extension communicates with these endpoints:

### POST /queue
**Purpose**: Submit initial inventory of existing packages
...
```json
{
  ...
  "ecosystem": "npm",
  "packages": [
    { "name": "react", "version": "18.3.1", "path": "package.json" }
  ],
  "timestamp": "2025-11-04T10:00:00.000Z"
}
```

### POST /dependencies/request
**Purpose**: Request approval for new dependency
...
```json
{
  ...
  "approved": true,
  "message": "Package is approved for use",
  "packageName": "lodash",
  "packageManager": "npm",
  "reasonUrl": "https://repogate.io/packages/lodash"
}
```

### POST /dependencies/update
**Purpose**: Notify of dependency changes (removal, version change)
