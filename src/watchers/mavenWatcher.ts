...
export class MavenWatcher {
    private watcher: vscode.FileSystemWatcher | undefined;
    private parser: MavenDependencyParser;
    ...
    /**
     * Start watching pom.xml files
     */
    async start() {
        // Check if workspace has a Git repository
        this.hasRepository = await GitDetector.hasRepository();
        
        this.watcher = vscode.workspace.createFileSystemWatcher('**/pom.xml');
        ...
        logger.info('Maven watcher started');
    }
    ...
    dispose() {
        ...
        logger.info('Maven watcher stopped');
    }
}
